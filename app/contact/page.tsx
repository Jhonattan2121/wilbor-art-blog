    ...
    return (
        <main className="flex flex-col items-center py-8 px-6">
            <div className="w-full max-w-md sm:max-w-lg lg:max-w-xl text-left">
                <h1 className="text-3xl sm:text-4xl font-bold text-left">Entre em Contato</h1>
                <p className="mt-2 text-lg sm:text-xl text-left">
                    Estou disponível para responder suas mensagens.
                </p>

                <div className="flex items-center gap-3 mt-6 py-2">
                    <svg viewBox="0 0 24 24" className="w-5 h-5 text-current" fill="currentColor">
                ...
                <div className="mt-8">
                    <h2 className="text-xl font-medium mb-3 text-left">Redes Sociais</h2>
                    <div className="flex items-center gap-3 mt-3 py-2">
                        <svg viewBox="0 0 24 24" className="w-5 h-5 text-current" fill="currentColor">
                        ...
                        <a href="https://www.instagram.com/wilbor_domina/" className="text-lg font-semibold hover:opacity-70 transition-all" target="_blank" rel="noopener noreferrer">
                            @wilbor_domina
                        </a>
                    </div>
                    <div className="flex items-center gap-3 mt-3 py-2">
                        ...
                        <a href="https://vimeo.com/wilbor" className="text-lg font-semibold hover:opacity-70 transition-all" target="_blank" rel="noopener noreferrer">
                            vimeo.com/wilbor
                        </a>
                    </div>
                    <div className="flex items-center gap-3 mt-3 py-2">
                        ...
                        <a href="https://odysee.com/@wilbor:4" className="text-lg font-semibold hover:opacity-70 transition-all" target="_blank" rel="noopener noreferrer">
                            odysee.com/@wilbor:4
                        </a>
                    </div>
                </div>
