                ...
                <div className="w-full text-left sm:px-6 md:px-12">
                    ...
                    <div className="flex items-center gap-3 mt-3 py-2">
                        ...
                        <div className="flex items-center gap-3 mt-3 py-2">
                            ...
                            <a href="https://www.instagram.com/wilbor_domina/" className="text-base font-semibold hover:opacity-70 transition-all" target="_blank" rel="noopener noreferrer">
                                @wilbor_domina
                            </a>
                        </div>
                        <div className="flex items-center gap-3 mt-3 py-2">
                            ...
                            <a href="https://vimeo.com/wilbor" className="text-base font-semibold hover:opacity-70 transition-all" target="_blank" rel="noopener noreferrer">
                                vimeo.com/wilbor
                            </a>
                        </div>
                        <div className="flex items-center gap-3 mt-3 py-2">
                            ...
                            <a href="https://odysee.com/@wilbor:4" className="text-base font-semibold hover:opacity-70 transition-all" target="_blank" rel="noopener noreferrer">
                                odysee.com/@wilbor:4
                            </a>
                        </div>
                    </div>
